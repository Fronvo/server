...
function accountExists({ socket }: Partial<TestArguments>, callback: TestErrorCallback): void {
...
function register({ socket, done, shared }: TestArguments, callback: TestErrorCallback): void {
    socket.emit('logout');
