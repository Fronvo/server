...
const errors: { [Error in Errors] } = {
    ...
    MUST_BE_LOGGED_IN: 'You must login first.',
    MUST_BE_LOGGED_OUT: 'You must logout first.',
    ...
    ACCOUNT_ALREADY_EXISTS: 'This email has already been registered.',
    ACCOUNT_DOESNT_EXIST: 'No such account exists.',
    ...
    INVALID_ID: 'This ID has been taken.',
